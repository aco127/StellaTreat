...
public class Week4CountofCardsonPortal {
	
	WebDriver driver;
	WebDriverWait wait;
	JavascriptExecutor js = (JavascriptExecutor) driver;

	public Week4CountofCardsonPortal(WebDriver driver) {
		this.driver = driver;
	...
	public String[] checkweek4day1card () throws InterruptedException
	{
		programtab.click();
		Thread.sleep(3000);
...
str[i]=trimtext;		
	...
	public String[] checkweek4day2card() throws InterruptedException
	{
		programtab.click();
...
str[i]=trimtext;		
	...
	public String[] checkweek4day3card() throws InterruptedException
	{
		programtab.click();
...
str[i]=trimtext;		
	...
	public String[] checkweek4day4card() throws InterruptedException
	{
		programtab.click();
...
str[i]=trimtext;		
	...
	public String[] checkweek4day5card() throws InterruptedException
	{
		programtab.click();
