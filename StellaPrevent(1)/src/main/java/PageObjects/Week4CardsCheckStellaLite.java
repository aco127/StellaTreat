...
public class Week4CardsCheckStellaLite {
	WebDriver driver;
	Properties prop;

	public Week4CardsCheckStellaLite(WebDriver driver) {
 this.driver = driver; PageFactory.initElements(driver, this);
	...
	public String[] checkcardcountsonappWeek4day1() throws InterruptedException
	{Thread.sleep(2000);
		PastModuleTab.click();
	...
	public String[] checkcardcountsonappWeek4day2() throws InterruptedException
	{
	...
	public String[] checkcardcountsonappWeek4day3() throws InterruptedException
	{
		driver.navigate().back();
		Thread.sleep(1000);
	...
	public String[] checkcardcountsonappWeek4day4() throws InterruptedException
	{
		driver.navigate().back();
		Thread.sleep(1000);
	...
	public String[] checkcardcountsonappWeek4day5() throws InterruptedException
	{
		driver.navigate().back();
		Thread.sleep(1000);
