...
public class Week5CardsCheckStellaLite {
	WebDriver driver;
	Properties prop;

	public Week5CardsCheckStellaLite(WebDriver driver) {
 this.driver = driver; PageFactory.initElements(driver, this);
	...
	/*
	 * @FindBy(xpath="//span[normalize-space()='5']") WebElement week5;
	 */
	...
	@FindBy(xpath="//option[@value='Module 5']")
	WebElement week5;
	
	String str[]=null;
	
	public String[] checkcardcountsonappWeek5day1() throws InterruptedException
	{Thread.sleep(5000);
		PastModuleTab.click();
	...
	public String[] checkcardcountsonappWeek5day2() throws InterruptedException
	{
	...
	public String[] checkcardcountsonappWeek5day3() throws InterruptedException
	{
		driver.navigate().back();
		Thread.sleep(1000);
	...
	public String[] checkcardcountsonappWeek5day4() throws InterruptedException
	{
		driver.navigate().back();
		Thread.sleep(1000);
	...
	public String[] checkcardcountsonappWeek5day5() throws InterruptedException
	{
		driver.navigate().back();
		Thread.sleep(1000);
