...
public class Week3CountofCardsonPortal {
	
	WebDriver driver;
	WebDriverWait wait;
	JavascriptExecutor js = (JavascriptExecutor) driver;

	public Week3CountofCardsonPortal(WebDriver driver) {
		this.driver = driver;
	...
	public String[] checkweek3day1card () throws InterruptedException
	{
		programtab.click();
		Thread.sleep(3000);
...
str[i]=trimtext;		
	...
	public String[] checkweek3day2card() throws InterruptedException
	{
		programtab.click();
...
str[i]=trimtext;		
	...
	public String[] checkweek3day3card() throws InterruptedException
	{
		programtab.click();
...
str[i]=trimtext;		
	...
	public String[] checkweek3day4card() throws InterruptedException
	{
		programtab.click();
...
str[i]=trimtext;		
	...
	public String[] checkweek3day5card() throws InterruptedException
	{
		programtab.click();
