...
public class Week2CountofCardsonPortal {
	
	WebDriver driver;
	WebDriverWait wait;
	JavascriptExecutor js = (JavascriptExecutor) driver;

	public Week2CountofCardsonPortal(WebDriver driver) {
		this.driver = driver;
	...
	public String[] checkweek2day1card () throws InterruptedException
	{
		programtab.click();
...
str[i]=trimtext;		
	...
	public String[] checkweek2day2card() throws InterruptedException
	{
		programtab.click();
...
str[i]=trimtext;		
	...
	public String[] checkweek2day3card() throws InterruptedException
	{
		programtab.click();
...
str[i]=trimtext;		
	...
	public String[] checkweek2day4card() throws InterruptedException
	{
		programtab.click();
...
str[i]=trimtext;		
	...
	public String[] checkweek2day5card() throws InterruptedException
	{
		programtab.click();
