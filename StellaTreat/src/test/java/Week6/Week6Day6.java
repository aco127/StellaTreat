...
import WEEK6.DailyLearningWeek6Day6;
import WEEK6.Week6Data;

public class Week6Day6 {
	 ...
	 */
	  ...
	  @Test(priority=2) 
	  public void checklearningWeek6Day6() throws InterruptedException, IOException 
	  {
		  Week6Data w= new Week6Data();
		  w.checkDay6();
		  DailyLearningWeek6Day6 d = new DailyLearningWeek6Day6();
		//  d.dailylearning();
		  Thread.sleep(2000);
		  d.RightswipeWeek6();
		  System.out.println("Week6 Day6 Completed");
	  }
