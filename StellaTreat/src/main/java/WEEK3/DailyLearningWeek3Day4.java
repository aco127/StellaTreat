...
public class DailyLearningWeek3Day4 {
	AndroidDriver driver;

	public DailyLearningWeek3Day4() {
	...
	@FindBy(xpath = "//android.widget.ScrollView/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.widget.EditText[1]")
	static WebElement worrytext;
	...
	static WebElement worryattribute;
	...
	public static void RightswipeWeek3() throws InterruptedException {
		...
		for (int i = 0; i <=12; i++) {
			...
			{
				try {
					worrytext.sendKeys("Testing worry");
					petname.sendKeys("Testing Petname");
					Scroll.presskeydown();
					Thread.sleep(2000);
					worryattribute.sendKeys("Testing Worry Attribute");
