...
public class DailyLearningWeek3Day5 {
	AndroidDriver driver;

	public DailyLearningWeek3Day5() {
	...
	public static void RightswipeWeek3() throws InterruptedException {
		...
		for (int i = 0; i <=12; i++) {
			...
			{
				try {
					EditText.sendKeys("Testing Thoughts");
					Submit.click();
				act2.click();
					
					Scroll.scrollIntoView("SUBMIT");
					EditText.sendKeys("Testing constructive thinking style");
					Submit.click();
					back.click();
					break;
				} 
