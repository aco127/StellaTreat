...
public class DailyLearningWeek5Day4 {
	AndroidDriver driver;

	public DailyLearningWeek5Day4() {
		...
		for (int i = 1; i <13; i++) {
			...
			if (i>= 5 && i<=7) {
				try {
					...
					EditText.sendKeys("Testing Journaling Activity");
					Submit.click();
				} 
				catch (Exception e) {
			...
			if (i ==11) {
				try {
					EditText.sendKeys("Testing Manage conflicts");
					Submit.click();
					/*
					 * ok.click(); back.click(); break;
					 */
				} catch (Exception e) {
