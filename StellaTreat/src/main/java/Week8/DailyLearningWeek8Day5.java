...
public class DailyLearningWeek8Day5 {
	AndroidDriver driver;

	public DailyLearningWeek8Day5() {
	...
	static WebElement thinking;

	@FindBy(xpath="//android.widget.TextView[@text='Disqualifying the Positive']")
	static WebElement disqualifyingthepositive;
	...
	public static void RightswipeWeek8() throws InterruptedException {
		...
		for (int i = 1; i <20; i++) {
			...
			if (i==15) {
				...
				try {
					thinking.click();
					disqualifyingthepositive.click();
			...
			if (i==16)
			{
				Thread.sleep(1000);
				try {
					EditText.sendKeys("Testing Balance thought to be");
