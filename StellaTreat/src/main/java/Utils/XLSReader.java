...
public class XLSReader {
		...
		public String getCellData(String sheetName, String colName, int rowNum) {
			try {
				...
				// if(cell.getCellType()==XLSReader.CELL_TYPE_STRING)
				// return cell.getStringCellValue();
		...
		public boolean setCellData(String sheetName, String colName, int rowNum, String data) {
			try {
				//fis = new FileInputStream(path);
			//	FileInputStream fis = new FileInputStream("C:\\Users\\shilp\\eclipse-workspace\\Appium\\src\\main\\java\\TestData\\Testdataa.xlsx");
				//path="C:\\Users\\shilp\\eclipse-workspace\\Appium\\src\\main\\java\\TestData\\Testdataa.xlsx";
		...
		//
		// XSSFHyperlink link = createHelper.createHyperlink(XLSReader.LINK_FILE);
		// link.setAddress(url);
		...
		public void writetosheet(String sheetname,String filePath)
		{
