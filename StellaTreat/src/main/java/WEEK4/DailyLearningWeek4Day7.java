...
public class DailyLearningWeek4Day7 {
	static AndroidDriver driver;

	public DailyLearningWeek4Day7() {
	...
	public static void swipeHorizontal(AndroidDriver driver, double startPercentage, double finalPercentage,
		...
		new TouchAction((PerformsTouchActions) AppDriver.getDriver()).press(PointOption.point(startPoint, anchor))
