...
public class MobileActions {
	...
	/*
	 * public MobileActions (AndroidDriver driver) { this.driver = driver; }
	 */
	...
	/*
	 * public void swipe(AndroidElement ele,AndroidElement el1) { new
	 * TouchAction(driver).press(ele).moveTo(el1).release().perform(); }
	 */
